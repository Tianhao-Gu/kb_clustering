...
class kb_ke_util(object):
    ...
    def linkage_2_newick(self, params, context=None):
        ...
        """
        return self._client.run_job('kb_ke_util.linkage_2_newick',
    ...
    def run_PCA(self, params, context=None):
        ...
        """
        return self._client.run_job('kb_ke_util.run_PCA',
                                    [params], self._service_ver, context)
    ...
    def run_kmeans2(self, params, context=None):
        ...
        """
        return self._client.run_job('kb_ke_util.run_kmeans2',
                                    [params], self._service_ver, context)
    ...
    def run_pdist(self, params, context=None):
        ...
        :returns: instance of type "PdistOutput" (Ouput of the run_pdist
           ...
           String
        """
        return self._client.run_job('kb_ke_util.run_pdist',
                                    [params], self._service_ver, context)
    ...
    def run_linkage(self, params, context=None):
        ...
        :returns: instance of type "LinkageOutput" (Ouput of the run_linkage
           ...
           of list of Double
        """
        return self._client.run_job('kb_ke_util.run_linkage',
                                    [params], self._service_ver, context)
    ...
    def run_fcluster(self, params, context=None):
        ...
        """
        return self._client.run_job('kb_ke_util.run_fcluster',
                                    [params], self._service_ver, context)
    ...
    def run_dendrogram(self, params, context=None):
        ...
        """
        return self._client.run_job('kb_ke_util.run_dendrogram',
                                    [params], self._service_ver, context)
    ...
    def build_biclusters(self, params, context=None):
        ...
        """
        return self._client.run_job('kb_ke_util.build_biclusters',
                                    [params], self._service_ver, context)
    ...
    def enrich_onthology(self, params, context=None):
        ...
        """
        return self._client.run_job('kb_ke_util.enrich_onthology',
                                    [params], self._service_ver, context)
    ...
    def calc_onthology_dist(self, params, context=None):
        ...
        :returns: instance of type "CalcOnthologyDistOutput" (Ouput of the
           ...
           "gene_id" to Long
        """
        return self._client.run_job('kb_ke_util.calc_onthology_dist',
                                    [params], self._service_ver, context)
    ...
    def calc_weighted_onthology_dist(self, params, context=None):
        ...
        :returns: instance of type "CalcOnthologyDistOutput" (Ouput of the
           ...
           "gene_id" to Long
        """
        return self._client.run_job('kb_ke_util.calc_weighted_onthology_dist',
                                    [params], self._service_ver, context)

    def status(self, context=None):
        return self._client.run_job('kb_ke_util.status',
