...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_clustering'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_clustering.kb_clusteringImpl import kb_clustering  # noqa @IgnorePep8
impl_kb_clustering = kb_clustering(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_clustering'
